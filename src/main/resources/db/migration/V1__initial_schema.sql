...
CREATE TABLE users_roles (
    uid UUID NOT NULL, 
    role_id BIGINT NOT NULL,
    CONSTRAINT pk_users_roles PRIMARY KEY (uid, role_id),
    CONSTRAINT fk_users_roles_user FOREIGN KEY (uid) 
...
CREATE TABLE bookings (
    ...
    guest_id UUID NOT NULL, -- UUID to reference User's uid
...
CREATE TABLE reviews (
    ...
    reviewer_id UUID NOT NULL, -- UUID to reference User's uid
    reviewee_id UUID NOT NULL, -- UUID to reference User's uid
...
CREATE TABLE messages (
    id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    booking_id BIGINT NOT NULL,
    sender_id UUID NOT NULL, -- UUID to reference User's uid
    content TEXT NULL,
    created_at TIMESTAMPTZ NOT NULL,
    updated_at TIMESTAMPTZ NOT NULL,
    deleted BOOLEAN NOT NULL DEFAULT FALSE,
